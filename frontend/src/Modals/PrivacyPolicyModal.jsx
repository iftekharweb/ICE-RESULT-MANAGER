...
const PrivacyPolicyModal = ({ handlePolicy }) => {
  return (
      ...
      <div className="bg-white py-5 px-8 rounded-xl w-[60%] max-h-[90vh] overflow-y-auto">
        ...
        <div className="max-w-4xl mx-auto p-6 my-8 bg-white rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            ...
            contact details.
            <br />- <strong>Usage Data:</strong> We collect information about
          ...
          <p className="text-gray-600 mb-4">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>
                Ensure compliance with university policies and legal
                obligations.
              </li>
            </ul>
          </p>
          ...
          <p className="text-gray-600 mb-4">
            ...
            <ul className="list-disc list-inside ml-4">
              <li>
                <strong>University Administration:</strong> To facilitate
