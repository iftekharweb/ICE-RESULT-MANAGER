...
const CreateStudentModal = ({ handleAdd }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${import.meta.env.VITE_BASEURL}/register/`, {name, email, role, password}, {
        headers: {
          ...
          <div>
            <form action="#" onSubmit={handleSubmit}>
              ...
              <div className="w-full flex justify-center items-center">
                <button className="text-md font-semibold text-gray-500 hover:text-[#03C9D7] flex justify-center items-center" type="submit">
                  {" "}
